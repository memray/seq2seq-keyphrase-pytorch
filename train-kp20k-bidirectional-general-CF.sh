...
#SBATCH --job-name=train-kp20k-bidirectional-TeacherForcing-CF
#SBATCH --output=slurm_output/train-kp20k-bidirectional-TeacherForcing-CF.out
#SBATCH --nodes=1
