...
srun python -m train data_path_prefix data/$DATA_NAME/$DATA_NAME -vocab_path data/$DATA_NAME/$DATA_NAME.vocab.pt -exp "$DATA_NAME" -batch_size 128 -bidirectional -run_valid_every 5000 -save_model_every 5000 -beam_size 32 -beam_search_batch_size 3 -train_ml
