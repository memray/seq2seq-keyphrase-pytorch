...
srun python -m predict -train_from model/prelim_copy/kp20k-copy.20171203-034153/kp20k-copy.epoch=3.batch=55088.total_batch=185000.model -data data/kp20k/kp20k -vocab_file data/kp20k/kp20k.vocab.pt -exp_path "exp/%s.%s" -exp "kp20k" -copy_model -bidirectional -batch_size 16 -beam_search_batch_size 1  -batch_workers 4 -must_appear_in_src -beam_size ${beam_size}
done
