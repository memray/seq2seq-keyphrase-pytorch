...
class SequenceGenerator(object):
    ...
    def beam_search(self, src_input, src_len, src_oov, oov_list, word2id):
        ...
        for current_len in range(1, self.max_sequence_length + 1):
            ...
            if num_partial_sequences == 0:
                # We have run out of partial candidates; often happens when
                # beam_size is small
                break
            ...
            for batch_i in range(batch_size):
                ...
                for partial_id, partial_seq in enumerate(partial_sequences[batch_i].extract()):
                    ...
                    # check each new beam and decide to add to hypotheses or
                    # completed list
                    for beam_i in range(self.beam_size + 1):
                        ...
                        # score=0 means this is the first word <BOS>, empty the
                        # sentence
        ...
        for batch_i in range(batch_size):
            ...
            complete_sequences[batch_i] = complete_sequences[
                batch_i].extract(sort=True)
    ...
    def sample(self, src_input, src_len, src_oov, oov_list, word2id, k, mode="greedy"):
        ...
        for current_len in range(1, self.max_sequence_length + 1):
            ...
            # probs, words are [batch_size, k] at time 0, and [batch_size * k,
            # 1] later on
