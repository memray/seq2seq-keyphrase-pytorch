...
def preprocess_opts(parser):
    ...
    parser.add_argument('-max_src_seq_length', type=int, default=10,
                        help="Maximum source sequence length")
    parser.add_argument('-min_src_seq_length', type=int, default=300,
...
def train_opts(parser):
    ...
    parser.add_argument('-datatrain', required=True,
                        help="""Path prefix to the ".train.pt" and
                        ".valid.pt" file path from preprocess.py""")
    parser.add_argument('-datavalid', required=True,
                        help="""Path prefix to the ".train.pt" and
                        ".valid.pt" file path from preprocess.py""")
